...
End users download `Any-Gender-Parenthook-v1.0.0-win64.zip` from GitHub
...
Maintainers build that ZIP with `build-release.ps1`. The end-user README source
is `END_USER_README.md`; it is copied to the package root as `README.md`.
