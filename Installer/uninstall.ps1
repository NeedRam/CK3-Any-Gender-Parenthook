...
& (Join-Path $PSScriptRoot 'powershell\engine.ps1') -Operation uninstall -TargetRoot $TargetRoot -PackageRoot $PackageRoot -Confirmation $Confirmation -Interactive:$Interactive -Json:$Json
exit $LASTEXITCODE
